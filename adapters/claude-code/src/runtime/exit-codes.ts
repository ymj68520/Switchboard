...
const EXIT_CODE_BY_ERROR: Readonly<Record<RuntimeErrorCode, ExitCode>> = {
  ...
  CONTEXT_NOT_AVAILABLE: EXIT_CODES.domainState,
  CONTEXT_BUDGET_EXCEEDED: EXIT_CODES.domainState,
  MEMORY_REF_INVALID: EXIT_CODES.domainState,
  MEMORY_DETAIL_UNAVAILABLE: EXIT_CODES.domainState,
  OBSERVATION_NOT_FOUND: EXIT_CODES.domainState,
  OBSERVATION_CONFLICT: EXIT_CODES.domainState,
  OBSERVATION_CAPTURE_FAILED: EXIT_CODES.domainState,
  OBSERVATION_BLOB_MISSING: EXIT_CODES.domainState,
  OBSERVATION_BLOB_CORRUPT: EXIT_CODES.domainState,
  OBSERVATION_NOT_PROMOTABLE: EXIT_CODES.domainState,
  EVIDENCE_NOT_FOUND: EXIT_CODES.domainState,
  EVIDENCE_REVISION_NOT_FOUND: EXIT_CODES.domainState,
  EVIDENCE_REVISION_CONFLICT: EXIT_CODES.domainState,
  EVIDENCE_PROVENANCE_INVALID: EXIT_CODES.domainState,
  EVIDENCE_SOURCE_FINGERPRINT_UNAVAILABLE: EXIT_CODES.domainState,
  EVIDENCE_SCOPE_INVALID: EXIT_CODES.domainState,
  EVIDENCE_NEEDS_VALIDATION: EXIT_CODES.domainState,
  EVIDENCE_STATE_INVALID: EXIT_CODES.domainState,
  EVIDENCE_REVISION_NOT_CURRENT: EXIT_CODES.domainState,
  EVIDENCE_REVALIDATION_INVALID: EXIT_CODES.domainState,
  EVIDENCE_PROVENANCE_STALE: EXIT_CODES.domainState,
